...
$DB->Connect();
$DB->Update('DELETE FROM `tlx_captcha` WHERE `time_stamp` < ?', array(time() - 3600));
$DB->Update("INSERT INTO `tlx_captcha` VALUES (?, ?, ?)", array($session, $verification->code_as_string, time()));
$DB->Disconnect();
