...
function tlxPageAddBulk()
{
    ...
    $GLOBALS['ICON_CACHE'] =& $DB->FetchAll('SELECT * FROM `tlx_icons`', [], 'icon_id');
    $GLOBALS['CATEGORY_CACHE'] =& $DB->FetchAll('SELECT * FROM `tlx_categories`', [], 'category_id');
...
function tlxCategoryAdd()
{
    ...
    if( !isset($_REQUEST['recip_required']) ) $_REQUEST['recip_required'] = 0;
