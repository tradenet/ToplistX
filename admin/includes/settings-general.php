...
$defaults = array('document_root' => $_SERVER['DOCUMENT_ROOT'],
                  ...
                  'from_email' => 'noreply@' . preg_replace('~www\.~', '', $_SERVER['HTTP_HOST']),
                  'from_email_name' => 'ToplistX',
                  'email_type' => MT_PHP,
                  ...
                  'review_new_accounts' => 0,
                  'review_edited_accounts' => 0,
                  'confirm_accounts' => 0,
                  'email_new_accounts' => 0,
                  'min_title_length' => 10,
