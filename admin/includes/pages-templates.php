...
<div class="alert centered">
  You must setup at least one ranking page through the <a href="index.php?r=tlxShPages">Manage Pages</a> interface before you can edit the ranking page templates
</div>
  ...
  <div id="centered-content" class="max-width">
    <div class="heading">
      <div class="heading-icon">
        <a href="index.php?r=tlxShPageTemplateWizard" onclick="return openWizard();"><img src="images/wizard.png" border="0" alt="Template Wizard" title="Template Wizard"></a>
        &nbsp;
    ...
    <?php endif; ?>
    <a href="index.php?r=tlxShPageTemplateReplace" class="window {title: 'Template Search and Replace'}">
    ...
    <div class="heading">
      Editing template for <a href="<?php echo "http://{$_SERVER['HTTP_HOST']}/{$_REQUEST['page']['filename']}"; ?>" target="_blank" style="text-decoration: none;"><?php echo "http://{$_SERVER['HTTP_HOST']}/{$_REQUEST['page']['filename']}"; ?></a>
    </div>
