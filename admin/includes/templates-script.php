...
function checkForm()
{
    if( $('#r').val() == 'tlxScriptTemplateSave' )
    {
...
<div id="main-content">
  <div id="centered-content" class="max-width">
    ...
    <div class="centered margin-top" style="font-weight: bold">
      ...
      &nbsp;
      <button type="submit" onclick="$('#r').val('tlxScriptTemplateLoad')">Load Template</button>
    </div>
    ...
    <div class="centered margin-top" style="font-weight: bold">
    <button type="submit" onclick="$('#r').val('tlxScriptTemplateSave')">Save Template</button>
