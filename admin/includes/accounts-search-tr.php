<tr id="<?php echo str_replace('&quot;', '"', $item['username']); ?>" class="<?php echo $item['status']; ?>">
  ...
  <td>
    ...
    <img src="images/check.png" border="0" width="12" height="12" alt="Approve" title="Click to approve" class="click" onclick="return processEditSelected('<?php echo str_replace("'", "\\'", $item['username']); ?>', 'approve')">    
    <img src="images/x.png" border="0" width="12" height="12" alt="Reject" title="Click to reject" class="function click" onclick="return processEditSelected('<?php echo str_replace("'", "\\'", $item['username']); ?>', 'reject')">
    </div>
  ...
  <td style="text-align: right;" class="last"  valign="top">
    ...
    if( $item['banner_url'] ): 
    ?>
    <img src="images/banner.png" width="11" height="12" alt="Banner" title="Click to view banner" class="function click" onclick="showBanner(this,'<?php echo addslashes(html_entity_decode($item['banner_url_local'] ? $item['banner_url_local'] : $item['banner_url'])); ?>','<?php echo addslashes(html_entity_decode("{$item['banner_width']}x{$item['banner_height']}")); ?>')">
    <?php endif; ?>
    ...
    <img src="images/disabled.png" width="12" height="12" alt="Unlocked" title="Click to enable account" onclick="return doToSelected('<?php echo str_replace("'", "\\'", $item['username']); ?>', 'enable')" class="function click">
    <?php else: ?>
    <img src="images/enabled.png" width="12" height="12" alt="Unlocked" title="Click to disable account" onclick="return doToSelected('<?php echo str_replace("'", "\\'", $item['username']); ?>', 'disable')" class="function click">
    <?php endif; ?>
    
    <?php if( $item['locked'] ): ?>
    <img src="images/locked.png" width="12" height="12" alt="Locked" title="Click to unlock account" class="function click" onclick="return doToSelected('<?php echo str_replace("'", "\\'", $item['username']); ?>', 'unlock')">
    <?php else: ?>
    <img src="images/unlocked.png" width="12" height="12" alt="Unlocked" title="Click to lock account" onclick="return doToSelected('<?php echo str_replace("'", "\\'", $item['username']); ?>', 'lock')" class="function click">
    <?php endif; ?>
    
    <img src="images/stats.png" width="12" height="12" alt="Stats" title="Stats" class="click-image function" onclick="openStats('<?php echo str_replace("'", "\\'", $item['username']); ?>')">
    <img src="images/search.png" width="12" height="12" alt="Scan" title="Scan" class="click-image function" onclick="openScan('<?php echo str_replace("'", "\\'", $item['username']); ?>')">
    <a href="index.php?r=tlxShAccountEdit&username=<?php echo rawurlencode(str_replace('&quot;', '"', $item['username'])); ?>" class="window function {title: 'Edit Account'}">
    ...
    <a href="" onclick="return deleteSelected('<?php echo str_replace("'", "\\'", $item['username']); ?>')" class="function">
    ...
    <img src="images/check.png" border="0" width="12" height="12" alt="Approve" title="Click to approve" class="click" onclick="return processSelected('<?php echo str_replace("'", "\\'", $item['username']); ?>', 'approve')">    
    <img src="images/x.png" border="0" width="12" height="12" alt="Reject" title="Click to reject" class="function click" onclick="return processSelected('<?php echo str_replace("'", "\\'", $item['username']); ?>', 'reject')">

    <select name="reject[<?php echo str_replace('&quot;', '"', $item['username']); ?>]" id="reject_<?php echo str_replace('&quot;', '"', $item['username']); ?>" class="reject" style="margin-left: 5px;">
