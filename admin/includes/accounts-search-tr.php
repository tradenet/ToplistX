<tr id="<?php echo $item['username']; ?>" class="<?php echo $item['status']; ?>">
  ...
  <td>
    ...
    <img src="images/check.png" border="0" width="12" height="12" alt="Approve" title="Click to approve" class="click" onclick="return processEditSelected('<?php echo str_replace("'", "&#39;", html_entity_decode($item['username'])); ?>', 'approve')">    
    <img src="images/x.png" border="0" width="12" height="12" alt="Reject" title="Click to reject" class="function click" onclick="return processEditSelected('<?php echo str_replace("'", "&#39;", html_entity_decode($item['username'])); ?>', 'reject')">
    </div>
  ...
  <td style="text-align: right;" class="last"  valign="top">
    ...
    <img src="images/disabled.png" width="12" height="12" alt="Unlocked" title="Click to enable account" onclick="return doToSelected('<?php echo str_replace("'", "&#39;", html_entity_decode($item['username'])); ?>', 'enable')" class="function click">
    <?php else: ?>
    <img src="images/enabled.png" width="12" height="12" alt="Unlocked" title="Click to disable account" onclick="return doToSelected('<?php echo str_replace("'", "&#39;", html_entity_decode($item['username'])); ?>', 'disable')" class="function click">
    <?php endif; ?>
    
    <?php if( $item['locked'] ): ?>
    <img src="images/locked.png" width="12" height="12" alt="Locked" title="Click to unlock account" class="function click" onclick="return doToSelected('<?php echo str_replace("'", "&#39;", html_entity_decode($item['username'])); ?>', 'unlock')">
    <?php else: ?>
    <img src="images/unlocked.png" width="12" height="12" alt="Unlocked" title="Click to lock account" onclick="return doToSelected('<?php echo str_replace("'", "&#39;", html_entity_decode($item['username'])); ?>', 'lock')" class="function click">
    <?php endif; ?>
    
    <img src="images/stats.png" width="12" height="12" alt="Stats" title="Stats" class="click-image function" onclick="openStats('<?php echo str_replace("'", "&#39;", html_entity_decode($item['username'])); ?>')">
    <img src="images/search.png" width="12" height="12" alt="Scan" title="Scan" class="click-image function" onclick="openScan('<?php echo str_replace("'", "&#39;", html_entity_decode($item['username'])); ?>')">
    ...
    <a href="" onclick="return deleteSelected('<?php echo str_replace("'", "&#39;", html_entity_decode($item['username'])); ?>')" class="function">
    ...
    <img src="images/check.png" border="0" width="12" height="12" alt="Approve" title="Click to approve" class="click" onclick="return processSelected('<?php echo str_replace("'", "&#39;", html_entity_decode($item['username'])); ?>', 'approve')">    
    <img src="images/x.png" border="0" width="12" height="12" alt="Reject" title="Click to reject" class="function click" onclick="return processSelected('<?php echo str_replace("'", "&#39;", html_entity_decode($item['username'])); ?>', 'reject')">
